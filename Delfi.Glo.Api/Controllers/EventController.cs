...
namespace Delfi.Glo.Api.Controllers
{
    ...
    public class EventController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(int pageIndex, int pageSize, string? searchString, List<SortExpression> sortExpression)
        {
            Guard.Against.InvalidPageIndex(pageIndex);
            Guard.Against.InvalidPageSize(pageSize);

            var result = await _eventService.GetEvents(pageIndex, pageSize, searchString, sortExpression);
